...
То есть, если наша дата попадает между 21.03 и 20.4, то это Овен, а иначе, если наша дата попадает ...
...
Еще одно замечание: я не работаю над всеми ветками этого if, достаточно одной двух "набить руку". И если подход окажется работающим, добавить остальные ветки под копирку - уже дело техники. Вы ведь не думаете, что Вы способны забыть про них потом, и поэтому лучше сделать их сейчас? Если думаете так, то представьте другую ситуацию. Вы сделали все 12 веток, остались довольны своей скурпулезностью, но через некоторые время обрнаружили, что скелет этот (if этот в данном случае) вообще не годиться. Какое же разочарование, что столько времени были потрачено зря.
...
Так! Мы добрались до тех самых граблей, которые туда сами положили. Тот else там зачем? Затем, что теоретически может быть так, что дата не попала ни в один интервал! Мы спросите, как это так? Murphy говорит, что все может случиться - когда-нибудь обязательно случится! А мы подождем и подстрахуемся.
